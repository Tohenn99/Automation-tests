"""
Test Case 14: Post-Surgery Recovery Shopping
Patient buying comfortable recovery wear after surgery
"""
...
class TestRecoveryWearShopping:
    """Test 14: Patient buying comfortable recovery wear after surgery"""
    ...
    def test_recovery_comfort_clothing(self):
        """Patient ordering comfortable, easy-to-wear clothing for post-surgery recovery"""
        user_data = TestDataFactory.get_user_data_canada()
        user_data['name'] = 'Patricia Brown'
        ...
        self.products_page.add_nth_product(4, False)

        self.products_page.go_to_cart()
        self.cart_page.proceed_to_checkout()
        self.checkout_page.add_comment(
            "POST-SURGERY RECOVERY ORDER\n"
            "Recent surgery - need loose, comfortable clothing\n"
            "Easy to put on/take off (button front preferred)\n"
            "Soft fabrics, no tight elastic\n"
            "Size: Large (need extra room)\n"
            "Handle with care packaging please"
        )
