"""
Test Case 19: Wedding Planner Bulk Order
Wedding planner buying coordinated outfits for bridal party
"""
...
class TestWeddingPlannerOrder:
    """Test 19: Wedding planner buying coordinated outfits for bridal party"""
    ...
    def test_bridal_party_coordination(self):
        """Wedding planner ordering matching outfits for bridesmaids and groomsmen"""
        user_data = TestDataFactory.get_user_data_usa()
        user_data['name'] = 'Jennifer Martinez'
        user_data['address']['company'] = 'Elegant Events Wedding Planning'
        ...
        # Order coordinated outfits for wedding party
        ...
        self.checkout_page.add_comment(
            "WEDDING PLANNER - BRIDAL PARTY ORDER\n"
            "Company: Elegant Events Wedding Planning\n"
            "Wedding Date: January 25, 2025\n"
            "Client: Sarah & Michael Thompson\n"
            "Order: 3 bridesmaid dresses (sizes 4, 6, 8)\n"
            "      2 groomsmen shirts (sizes L, XL)\n"
            "Color coordination: Pastel theme (blush/champagne)\n"
            "URGENT: Need by January 10th for fittings\n"
            "Bill to: Wedding client account\n"
            "Deliver to: Elegant Events office\n"
            "Contact: Jennifer Martinez (555-0199)"
        )
